...
<body>
    ...
    <header>
        <div class="tblogo">
            ...
            <div class="ltext"><h1 >The VMK</h1></div>
        </div>
    ...
    <div class="banner">
        <div class="banner-content">
            <h1>Welcome to THE VMK HOTEL</h1>
    ...
    <footer>
        <p>Designed by : MADHANN KUMAR V</p>
    </footer>
...
<body>
    ...
    <div class="menu-container">
        ...
        <div class="menu-items">
            <div class="menu-item">
                <img src="1.jpeg" alt="Lobster Bisque">
    ...
    <footer>
        <p>Designed by : MADHANN KUMAR V(24010027)</p>
    </footer>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>THE VMK- contact us</title>
    <style>
        body {
            margin: 0;
            font-family: 'Arial', sans-serif;
...
<body>
    ...
    <section class="contact-section">
        <div class="contact-details">
            ...
            <p><strong>Email:</strong> VMK@gmail.com</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>THE VMK- Administration</title>
    <style>
        body {
            margin: 0;
            font-family: 'Arial', sans-serif;
...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="admin-items">
            ...
            <div class="admin-item">
                <img src="images2.jpg" alt="Manager">
                <div class="admin-details">
                    <h3>JOHN</h3>
            ...
            <div class="admin-item">
                <img src="IMAGE3.jpg" alt="Master Chef">
                <div class="admin-details">
                    <h3>SAVISH</h3>
            ...
            <div class="admin-item">
                <img src="IMAGE4.jpg" alt="Assistant Managing Director">
                <div class="admin-details">
                    <h3>ROLEX</h3>
